...
$base_url = $base_url ?? '';
$dashboard_url = ($role === 'member')
  ? $base_url . '/member/dashboard.php'
  ...
  <main class="main">
    ...
    <div class="topbar">
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        <a href="<?php echo $base_url; ?>/logout.php" class="btn btn-soft"><i class="fa-solid fa-right-from-bracket"></i></a>
      </div>
    </div>
