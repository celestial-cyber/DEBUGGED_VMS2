            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <select name="event_id" class="form-select" required>
                  ...
                  <?php
                  $select_events = mysqli_query($conn, "SELECT * FROM vms_events ORDER BY event_name ASC");
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-sm align-middle">
          ...
          <tbody>
            <?php
            $recent = mysqli_query($conn, "SELECT * FROM vms_visitors ORDER BY created_at DESC LIMIT 10");
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group btn-group-sm">
                    <?php if (!$v['in_time']) { ?>
                      <a class="btn btn-outline-primary" href="../actions/visitor_status.php?action=checkin&id=<?php echo (int)$v['id']; ?>&from=member_new-visitor.php"><i class="fa-solid fa-door-open"></i></a>
                    <?php } elseif (!$v['out_time']) { ?>
                      <a class="btn btn-outline-success" href="../actions/visitor_status.php?action=checkout&id=<?php echo (int)$v['id']; ?>&from=member_new-visitor.php"><i class="fa-solid fa-door-closed"></i></a>
                    <?php } else { ?>
