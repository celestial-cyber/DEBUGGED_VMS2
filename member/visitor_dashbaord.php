...
$member_query = mysqli_query($conn, "SELECT * FROM vms_members WHERE id='$id'");
$member_data = mysqli_fetch_assoc($member_query);

// Fetch upcoming events
$upcoming_events = mysqli_query($conn, "SELECT * FROM vms_events WHERE event_date >= CURDATE() ORDER BY event_date ASC");
...
$registered_events_query = mysqli_query($conn, "SELECT er.*, e.event_name, e.event_date 
                                                ...
                                                JOIN vms_events e ON er.event = e.event_name 
                                                WHERE er.user_id='$id'");
$registered_events = [];
...
$announcements = mysqli_query($conn, "SELECT * FROM vms_coordinator_notes WHERE note_type='LOG' ORDER BY created_at DESC LIMIT 5");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <span class="brand-text">SPECANCIENS VMS</span>
    ...
    <ul class="nav">
      <li><a href="member/dashboard.php" class="is-active"><i class="fa-solid fa-house"></i><span>Member Dashboard</span></a></li>
        ...
        <form id="profileForm" class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" name="department">
              ...
              <?php
              $depts = mysqli_query($conn, "SELECT * FROM vms_department WHERE status=1 ORDER BY department");
