...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM vms_excel_imports WHERE import_status = 'pending'";
    $params = [];
    $types = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['import'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM vms_excel_imports WHERE id = ?");
    ...
    if ($record) {
        ...
        $insert_sql = "INSERT INTO vms_visitors (event_id, name, email, mobile, address, department, gender, year_of_graduation, in_time, status, added_by, visitor_type)
        ...
        if ($stmt->execute()) {
            ...
            $update_sql = "UPDATE vms_excel_imports SET import_status = 'imported' WHERE id = ?";
...
<div class="container-fluid">
    ...
    <div class="alert alert-<?php echo htmlspecialchars($message_type === 'error' ? 'danger' : 'success'); ?> mb-3">
                ...
                <table class="table table-sm align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                $event_stmt = $conn->prepare("SELECT event_name FROM vms_events WHERE event_id = ?");
