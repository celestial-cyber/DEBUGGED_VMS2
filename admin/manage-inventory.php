...
<div class="container-fluid">
  ...
  <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
    ...
    <div class="d-flex gap-2">
      <button class="btn btn-primary" onclick="location.href='../actions/add_inventory.php'"><i class="fa-solid fa-plus me-2"></i>Add Item</button>
  ...
  <div class="card-lite">
    ...
    <div class="card-body">
        ...
        <table class="table table-sm align-middle">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo htmlspecialchars((string)($row['total_stock'] ?? '0')); ?></td>
              <td><?php echo htmlspecialchars((string)($row['used_count'] ?? '0')); ?></td>
              <td>
      ...
      <div class="d-flex justify-content-between align-items-center mt-3">
        <span class="muted">
          <?php
          $total_items = $select_query ? $select_query->num_rows : 0;
