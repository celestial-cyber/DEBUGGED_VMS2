...
if(isset($_POST['sv-vstr'])) {
    // Sanitize inputs (use null-coalescing defaults to avoid deprecated warnings)
            ...
            <form method="post" class="form-valide">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="roll_number" class="form-control" value="<?php echo htmlspecialchars($row['roll_number'] ?? '');?>" pattern="[A-Za-z0-9]{2,50}" title="2-50 alphanumeric characters" required>
                        </div>
                    </div>
                    <!-- In Time -->
                    <div class="form-group row">
