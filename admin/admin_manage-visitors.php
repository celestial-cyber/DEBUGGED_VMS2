...
<div class="container-fluid">
  ...
  <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
    ...
    <div class="d-flex gap-2">
      <button class="btn btn-primary" onclick="location.href='../public/new-visitor.php'"><i class="fa-solid fa-plus me-2"></i>Add Visitor</button>
        ...
        <table class="table table-sm align-middle">
          ...
          <tbody>
            ...
            if(isset($_REQUEST['srh-btn']))
            {
                ...
                $from_date = date('Y-m-d', strtotime($from_date ?: 'today'));
                $to_date = date('Y-m-d', strtotime($to_date ?: 'today'));
            ...
            { ?>
              ...
              $select_query = mysqli_query($conn, "select * from vms_visitors ORDER BY created_at DESC");
              $sn = 1;
