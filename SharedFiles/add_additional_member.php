...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insert into vms_visitors with relation info
    $sql = "INSERT INTO vms_visitors (event_id, name, email, mobile, address, department, gender, year_of_graduation, in_time, status, added_by, relation) 
            VALUES (?, ?, ?, ?, '', ?, ?, '', NOW(), 1, ?, ?)";
