...
<!-- FIXED LOGOS -->
<img src="Images/SALogo.png" alt="SPEC Logo" class="side-logo left">
<img src="Images/specanciens-logo.png" alt="SPECANCIENS Logo" class="side-logo right">
...
<div class="thankyou-overlay" id="thankyouCard">
    <div class="thankyou-card">
        ...
        <div>
            ...
            <button class="btn" onclick="window.location.href='admin_dashboard.php'" style="margin-left: 10px;">View Dashboard</button>
        </div>
    </div>
</div>
